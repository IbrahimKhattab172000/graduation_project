...
class GranolaWithHoneyScreen extends StatefulWidget {
  const GranolaWithHoneyScreen({Key? key}) : super(key: key);

  @override
  State<GranolaWithHoneyScreen> createState() => _GranolaWithHoneyScreenState();
}

class _GranolaWithHoneyScreenState extends State<GranolaWithHoneyScreen> {
  @override
        ...
        body: Stack(
          children: [
            Container(
              ...
              child: Image.asset(
                'assets/images/e7bc187b49d56d0b782cff2c2625d64d_w750_h500(1).jpg',
                fit: BoxFit.cover,
              ),
            ),
