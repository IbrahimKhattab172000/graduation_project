...
class ShowVideoSquatScreen extends StatefulWidget {

  final String? videoId;

  ShowVideoSquatScreen({required this.videoId});

  @override
  _ShowVideoSquatScreenState createState() => _ShowVideoSquatScreenState();
}

class _ShowVideoSquatScreenState extends State<ShowVideoSquatScreen> {
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("Squats Workout", style:  TextStyle(
